...
LLM provider documentation references older default model names. When updating Anthropic integration, prefer current Codex model IDs and keep frontend model labels, docs, and `config.llm.example.json` consistent.
